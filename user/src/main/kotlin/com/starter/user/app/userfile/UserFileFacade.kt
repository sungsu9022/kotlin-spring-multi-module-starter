...
import com.starter.core.tempfile.service.TempFileProcessor
import mu.KLogging
...
class UserFileFacade(
    ...
    private val tempFileProcessor: TempFileProcessor,
) {
    ...
    fun writeLocal(fileId: Long) {
        val tempFilePath = tempFileProcessor.getPrivatePath("test")
        for(i in 1..3) {
